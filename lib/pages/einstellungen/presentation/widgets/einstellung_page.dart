              ...
              children: <Widget>[
                ...
                SwitchListTile(
                  ...
                  onChanged: (val) async {
                    BlocProvider.of<EinstellungBloc>(context).add(
                        StoringPreferences(
                            "notifications_veranstaltungen", val));
                  },
                  title: Text(
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    onSubmitted: (value) => snapshot.data
                        .setInt("schedule_offset", int.parse(value)),
                ...
                SwitchListTile(
                  ...
                  onChanged: (val) async {
                    BlocProvider.of<EinstellungBloc>(context).add(
                        StoringPreferences("notifications_freizeiten", val));
                  },
                  title: Text(
